...
export function AddAgentCollectionMember(arg1:collection.AddMemberRequest):Promise<collection.CollectionView>;
...
export function RemoveAgentCollectionMember(arg1:collection.RemoveMemberRequest):Promise<collection.CollectionView>;
