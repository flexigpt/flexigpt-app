...
export function ListProvidedSkills(arg1:skillruntime.ListProvidedSkillsRequest):Promise<skillruntime.ListProvidedSkillsResponse>;
...
export function PutSkillArtifact(arg1:spec.PutSkillArtifactRequest):Promise<spec.PutSkillArtifactResponse>;

export function PutSkillBundle(arg1:spec.PutSkillBundleRequest):Promise<spec.PutSkillBundleResponse>;

export function RenderProvidedSkill(arg1:skillruntime.RenderProvidedSkillRequest):Promise<skillruntime.RenderProvidedSkillResponse>;
