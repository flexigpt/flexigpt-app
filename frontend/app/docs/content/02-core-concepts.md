...
FlexiGPT is designed as a local-first BYOK AI workspace, not only a chat box.
...
| Term                    | What it means                                                                                                                                                                       |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Provider**            | The API family or endpoint the app talks to, such as OpenAI, Anthropic, Google Gemini API, xAI, Mistral AI, Hugging Face, OpenRouter, `llama.cpp`, or a compatible custom endpoint. |
