...
func (s *AssistantPresetStore) PutAssistantPreset(
	...
	preset := spec.AssistantPreset{
		...
		StartingModelPresetRef:           jsonutil.CloneJSONInValue(req.Body.StartingModelPresetRef),
		StartingIncludeModelSystemPrompt: jsonutil.CloneJSONInValue(req.Body.StartingIncludeModelSystemPrompt),
		StartingToolSelections:           jsonutil.CloneJSONInValue(req.Body.StartingToolSelections),
		StartingSkillSelections:          jsonutil.CloneJSONInValue(req.Body.StartingSkillSelections),
		StartingMCPContext:               jsonutil.CloneJSONInValue(req.Body.StartingMCPContext),
		CreatedAt:                        now,
		ModifiedAt:                       now,
	}
...
func (s *AssistantPresetStore) readAllBundles(forceFetch bool) (spec.AllBundles, error) {
	...
	if !spec.IsSupportedSchemaVersion(all.SchemaVersion) {
