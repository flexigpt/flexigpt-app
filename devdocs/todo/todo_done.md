...
- [x] better software assistant using new skills.
  - [x] file level only software dev flow, guidance in tool that if replace text doesnt work fall to file based things.
...
- [x] test shell and hostspawn exec on win
  - [x] powershell is most probably not getting the default path as go mod verify did not work
...
- [x] cursor up and down has some jerk in composer, this is post a paste of some code. check any rerenders anyplace that can cause this.
...
- [x] pull artifactstore into main
